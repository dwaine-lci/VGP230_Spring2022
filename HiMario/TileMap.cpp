...
void TileMap::Init()
{
	...
	cMapTextures[2] = X::LoadTexture("yellow.jpg");
	cMapTextures[3] = X::LoadTexture("purple.jpg");
	cMapTextures[4] = X::LoadTexture("green.jpg");
	cMapTextures[5] = X::LoadTexture("red.jpg");
...
void TileMap::ReloadMap()
{
	...
	while (inputStream >> dataType)
	{
		...
		newData.tileType = (dataType < 4) ? TileType::Walkable : TileType::Platform;
